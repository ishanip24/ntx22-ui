...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jai/Desktop/Neurotech/PsychoPy/m_q.py',
...
r = visual.TextStim(win=win, name='r',
    ...
    languageStyle='LTR',
    depth=-11.0);
textbar = visual.TextStim(win=win, name='textbar',
    text='answer',
    font='Open Sans',
...
m__rComponents = [left_top_circle, left_bottom_circle, center_top_circle, center_bottom_circle, right_top_circle, right_bottom_circle, m, n, o, p, q, r, textbar]
